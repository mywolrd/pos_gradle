...
public class OrderTest {
    ...
    public void testTotalAmount1() {
        ...
        OrderDetails CarOrderDetails1 = TestUtils.CreateCarOrderDetails(price1,
                quantity_1, null);
        OrderDetails CarOrderDetails2 = TestUtils.CreateCarOrderDetails(price2,
                quantity_2, null);
        ...
        Assert.assertTrue("Should be equal",
                carOrder.getTotalAmount().equals(total));
    ...
    public void testTotalQuantity1() {
        ...
        Assert.assertTrue("Should be equal",
                carOrder.getTotalQuantity() == quantity_1 + quantity_2);
    }
